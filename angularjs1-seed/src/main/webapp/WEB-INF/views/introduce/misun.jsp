...
<div class="row simple-cards users-card">
    <div class="col-md-4 col-lg-4 col-sm-12">
        <div class="card user-card">
            <div class="card-header-img">
                <img class="img-fluid img-radius" src="${pageContext.request.contextPath }/resources/files/assets/images/user-card/img-round6.png" alt="card-img">
                <h4>김미선</h4>
    ...
    <div class="container col-md-8 col-lg-8 col-sm-12">
