...
<head>
    ...
    <script src="${pageContext.request.contextPath }/resources/app/misun/controller/IntroduceJeongukCtrl.js"></script>
    <script src="${pageContext.request.contextPath }/resources/app/misun/service/IntroduceJeongukService.js"></script>
        ...
        <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a ng-repeat="user in userList" class="dropdown-item" ui-sref="{{user.id}}" ng-click="setUser(user.id)">{{user.name}} <span class="small-text"> {{user.position}} / {{user.department}}</span></a>
                </div>
            </li>
        </ul>
    </div>
